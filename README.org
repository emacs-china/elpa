...
<script>
  ((window.gitter = {}).chat = {}).options = {
    room: 'emacs-china/chat'
  };
</script>
<script src="https://cdn.staticfile.org/gitter-sidecar/1.2.4/sidecar.js" async defer></script>
<nav id="bar">
  <div>
        ...
        <a class="nav-link orange" href="http://donate.emacs-china.org"> <i class="fa fa-heart" aria-hidden="true"></i> &nbsp;Donation</a>
